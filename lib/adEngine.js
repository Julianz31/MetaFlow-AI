...
function heroScenePrompt(angle, ctx, format, cleanLabel) {
  ...
  return `Use the EXACT product from the provided image as the HERO of a premium advertising scene. Keep its shape, color and dropper EXACTLY. ${labelRule(cleanLabel)}
...
async function prepareCreative({ angle, productContext, primaryColor, productImageBase64, format = 'vertical', existingCopy, adjustmentInstruction, cleanLabel = true }) {
