...
function templatePain(copy, color, w, h) {
  ...
  bullets(ctx, bItems, 36, bY, color, '#fff', 30, 56);
...
function templateDesire(copy, color, w, h) {
  ...
  bullets(ctx, bItems, 36, Math.round(h * 0.60), color, '#fff', 30, 56);
...
function templateAuthority(copy, color, w, h) {
  ...
  feats.forEach((f, i) => {
    ...
    txt(ctx, f, 92, fy + 32, 26, 'normal', '#f1f5f9', 'left');
  });
...
function templateGuarantee(copy, color, w, h) {
  ...
  bullets(ctx, bItems, 36, Math.round(h * 0.61), color, '#fff', 28, 54);
...
function templateCuriosity(copy, color, w, h) {
  ...
  hints.forEach((hint, i) => {
    ...
    txt(ctx, hint, 86, hy2, 28, 'normal', '#f1f5f9', 'left');
  });
