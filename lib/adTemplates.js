...
function templateDesire(copy, color, w, h, hasProduct) {
  ...
  fadeRect(ctx, 0, 0, w, h * 0.50, 'rgba(0,0,0,0.50)', 'rgba(0,0,0,0)');
  fadeRect(ctx, 0, h * 0.52, w, h * 0.48, 'rgba(0,0,0,0)', 'rgba(0,0,0,0.68)');

  ctx.fillStyle = color; ctx.fillRect(0, 0, w, 10);

  // Gold stars + badge
  txt(ctx, '★★★★★', w / 2, 52, 34, 'bold', '#f59e0b', 'center', undefined, false);
  txt(ctx, 'ALTAMENTE RECOMENDADO', w / 2, 80, 20, 'bold', '#f59e0b', 'center', undefined, false);

  // Big headline
  const headY = wrapText(ctx, copy.headline || 'Logra el resultado que siempre quisiste',
    w / 2, 106, w - 60, 72, 'bold', '#ffffff', 88, 'center');

  // Color underline
  roundRect(ctx, w / 2 - 120, headY + 2, 240, 6, 3, color);
  ...
  const bulletMaxW = hasProduct ? Math.round(w * 0.50) : w - 76;
  bullets(ctx, bItems, 34, Math.round(h * 0.60), color, '#fff', 34, 68, bulletMaxW);

  ctaFull(ctx, w, h, color, copy.cta || 'Lo quiero ahora');
  ctx.fillStyle = color; ctx.fillRect(0, h - 10, w, 10);
...
function templateSocialProof(copy, color, w, h) {
  ...
  txt(ctx, '★★★★★', w / 2, 204, 36, 'bold', '#f59e0b', 'center', undefined, false);
  ...
  txt(ctx, '★★★★★', 120, cardY1 + 32, 22, 'bold', '#f59e0b', 'left', undefined, false);
  ...
  txt(ctx, '★★★★★', 120, cardY2 + 32, 22, 'bold', '#f59e0b', 'left', undefined, false);
