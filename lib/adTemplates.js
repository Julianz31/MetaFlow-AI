...
function templateDesire(copy, color, w, h, hasProduct) {
  ...
  // Gold stars (drawn, not emoji — emoji rendering unreliable on Lambda)
  drawStars(ctx, w / 2 - 5 * 20, 42, 5, 15, '#f59e0b');
  txt(ctx, 'ALTAMENTE RECOMENDADO', w / 2, 76, 20, 'bold', '#f59e0b', 'center', undefined, false);
